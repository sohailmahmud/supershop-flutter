...
class ProductModel {
  ...
  ProductModel.fromJson(Map json) {
    ...
    productPrice = json['price'] != null && json['price'] != ''
        ? double.parse(json['price']).toStringAsFixed(1)
        : '0';
    productRegPrice =
        json['regular_price'] != null && json['regular_price'] != ''
            ? double.parse(json['regular_price']).roundToDouble().toString()
            : '0';
    productSalePrice = json['sale_price'] != null && json['sale_price'] != ''
        ? double.parse(json['sale_price']).round().toString()
        : '';
    ...
    discProduct = productSalePrice.isNotEmpty
        ? discProduct =
